...
class ModifyRelicDialog:
    ...
    def search_effects(self, effect_index):
        ...
        if self.safe_mode_var.get():
            ...
            if is_curse_slot:
                _pool_effects = self.game_data.get_rollable_effects("curse")
            elif self.game_data.is_deep_relic(_cut_relic_id):
                _pool_effects = self.game_data.get_rollable_effects("deep")
            else:
                _pool_effects = self.game_data.get_rollable_effects("normal")
            ...
            # Check compatibility with other 2 effects
